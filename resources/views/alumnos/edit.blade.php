    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('alumnos.update', $alumno) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="correo" id="correo" class="form-control" value="{{ $alumno->correo }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ciudad" id="ciudad" class="form-control" value="{{ $alumno->ciudad }}" required>
            </div>
